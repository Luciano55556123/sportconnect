<div class="col-md-6 col-xl-4">
    <article class="event-card h-100">
        ...
        <div class="p-3">
            <div class="d-flex justify-content-between gap-2 mb-2"><span class="badge text-bg-primary"><?= e($event['sport_name']) ?></span><span class="small text-muted"><?= e(date('d/m/Y', strtotime($event['event_date']))) ?></span></div>
            <h3><?= e($event['name']) ?></h3>
